...
const StickerPeel: React.FC<StickerPeelProps> = ({
  ...
  useEffect(() => {
    ...
    const draggableInstance = Draggable.create(target, {
      type: 'x,y',
      bounds: boundsEl,
      inertia: true,
  ...
  return (
    <div
      className={`absolute transform-gpu ${draggable ? 'cursor-grab active:cursor-grabbing' : ''} ${className}`}
      ref={dragTargetRef}
      style={cssVars}
    >
      <style
        dangerouslySetInnerHTML={{
          ...
          .sticker-text {
            font-family: 'Smilecake', sans-serif;
      ...
      >
        <div className="sticker-main relative" style={stickerMainStyle}>
